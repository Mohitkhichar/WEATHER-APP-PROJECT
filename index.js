...
// initially variable need??  // currentTab = oldTab and clickedTab = newTab
let oldTab = userTab;
const API_KEY = "94fd63e0a8081c0a1ed340609c9483d9";
...
// check if coordinates are alerady present in session storage
...
async function fetchUserWeatherInfo(coordinates) {
    ...
    try {
        ...
        renderWeatherInfo(data); // ye wala function data se value nikal ke userinfocontainer wale UI ke andar put-in karega
    }
    catch(err) {
        loadingScreen.classList.remove("active");
        // HW
